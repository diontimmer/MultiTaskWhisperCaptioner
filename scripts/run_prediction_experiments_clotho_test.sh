...
do
    ...
    RUN_NAME=stilted-vortex-116 # fancy-galaxy-115 # trim-snow-114 # rose-lake-75 # atomic-sky-43 # magic-mountain-74 # efficient-jazz-72 # dainty-yogurt-57 # mythical-trooper-62 (lora?)
    CHECKPOINT=1500 # 3900 # 1500 # 2000 # 1000 # 13500 # 6200  # 1000 # 2600
    SPLIT=test
